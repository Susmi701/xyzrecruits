...
ActiveRecord::Schema[7.1].define(version: 2024_08_12_123407) do
  ...
  create_table "application_skills", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  add_foreign_key "application_skills", "applications"
